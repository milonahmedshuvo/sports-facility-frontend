    ...
    return (
        <div className="mx-10  mt-14 lg:mt-32">
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10'>
                ...
                <div className='relative bg-cover bg-center h-[400px]' style={{
                    ...
                    <div className='z-10 absolute left-8 bottom-6'>
                        ...
                        <p className='text-lg text-[26px] mt-4 leading-none font-semibold'>Mush-Have Equipment for</p>
                        <p className='text-lg text-[26px] mt-2 leading-none font-semibold'>Every Runner</p>
