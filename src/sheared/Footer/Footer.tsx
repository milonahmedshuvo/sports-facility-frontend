  ...
  return (
    <div className=' mt-32 pb-20 bg-black pt-32'>
      ...
      <div className='flex mx-20 '>
        ...
        <div className='w-[70%] flex flex-col md:flex-row justify-between ml-10 '>
          ...
          <div className=' w-[30%] flex flex-col items-center  '>
            ...
            <p className='text-xl font-inter text-white mt-2 ' >Contact Us</p>
          </div>
      ...
      <div className='flex justify-between mx-20 border-t-[1px] border-gray-400 mt-24'>
        <p className='mt-5' >
