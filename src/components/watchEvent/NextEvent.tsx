  ...
  return (
    <div className=' pt-5 border-t-2 flex justify-between relative mt-32 mx-0 md:mx-10 '>
        ...
        <div className='w-2/5 relative'>
           <h2 className='text-6xl font-bold uppercase text-black'>Memories are</h2>
           <h2 className='text-6xl font-bold uppercase text-black'>for ever!</h2>
           <h5 className=' mt-10 text-xl text-[#000000] w-full'>Paris 2024 Paralympics Collection!</h5>
